...
public class ItemBalance {
    ...
    protected static final double SAGE_CHANCE = 0.0005;//0.0005
    ...
    protected static final double[] RARITY_CHANCES = { //check by doing Math.rand() and seeing if less than value
            1.0,
            0.06, //6% rare or better //0.06
            0.03, //3% epic or better //0.03
            0.01, //1% unique or better //0.01
            0.003, //0.3% supreme or better //0.003
            0.0008, //0.08% legendary or better //0.0008
            0.0001, //0.01% godlike (1 in 10000) //0.0001
    };
     ...
     * Prefixes
     */
    protected static final double[] DURABILLITY_CHANCES ={
    		1.0 ,//tier 1 broken
    		0.4, //tier 2 fine 
    		0.01//tier 3 perfect
    };
    public static final String[] DURAB_NAMES={
    		"Broken",//0
    		"Fine",//1
    		"Perfect",//2
    };
    public static String getDUrName(int durZeroIndexed) {
        return DURAB_NAMES[durZeroIndexed];
    }
