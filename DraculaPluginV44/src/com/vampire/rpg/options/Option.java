...
public enum Option {
 ...
 //   COMPACT_REGION_MESSAGES("Compact Region Messages", true, "Use compact one-line region messages.", "Use detailed region messages."),
  ...
  //  SOFT_LAUNCH("Soft Launch Message", true, "Receive the kinda spammy message about how this is still a soft launch.", "Hide the soft launch message."),
    ...
    WEATHER_REGIONS("Weather Display",true,"Display weather changes between regions","Don't display rain and thunder when in such regions"),
    TAGS_ABOVE_ITEMS("Floating Text Above Items",true,"Display the item's name when thrown to the ground","Dont display the item's name when thrown to the ground"),
   // BLOOD_PARTICLE("Blood Particles",true,"Spawn blood particles when damaging an entity","Do not spawn blood particles"),
    ;
    ...
    Option(String display, boolean def, String t, String f) {
    ...
    public static Option get(String s) {
