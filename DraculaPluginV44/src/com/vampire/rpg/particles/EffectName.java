...
public enum EffectName {
    ...
    QUAD_HELIX("Quad Helix",CosmeticRarity.EPIC,"A quad helix that incircles you"),
    ...
    ZELLUMINATI("Dracolluminati", CosmeticRarity.LEGENDARY, "The symbol of one of Dracona's oldest secret societies."),
    ;
    public String name;
