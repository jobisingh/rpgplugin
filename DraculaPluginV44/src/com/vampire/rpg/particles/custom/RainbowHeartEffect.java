 ...
 */
public class RainbowHeartEffect extends Effect {
    ...
    public RainbowHeartEffect(EffectManager effectManager) {
        super(effectManager);
    ...
    public void onRun() {
        ...
        for (int i = 0; i < particles; i++) {
            ...
            display(particle, location.add(vector), VamUtils.randomColor());
