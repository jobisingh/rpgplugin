package com.vampire.rpg.particles;

import org.bukkit.Color;
import org.bukkit.entity.Player;

import com.vampire.rpg.particles.custom.AtomicEffect;
import com.vampire.rpg.particles.custom.BloodHelixEffect;
import com.vampire.rpg.particles.custom.ColoredHeartEffect;
import com.vampire.rpg.particles.custom.ColoredImageEffect;
import com.vampire.rpg.particles.custom.CustomWarpEffect;
import com.vampire.rpg.particles.custom.EmeraldStarEffect;
import com.vampire.rpg.particles.custom.FlameBreathEffect;
import com.vampire.rpg.particles.custom.InfernoTagEffect;
import com.vampire.rpg.particles.custom.MusicalEffect;
import com.vampire.rpg.particles.custom.QuadHelixEffect;
import com.vampire.rpg.particles.custom.RainbowHeartEffect;
import com.vampire.rpg.particles.custom.RainyDayEffect;
import com.vampire.rpg.particles.custom.SparkRingEffect;
import com.vampire.rpg.particles.custom.SwirlyEffect;
import com.vampire.rpg.particles.custom.WaterSpoutEffect;
import com.vampire.rpg.particles.custom.WingsEffect;
...
public class EffectFactory {
  ...
  /*  public static CustomWarpEffect getWarpEffect(Player p, int time) {
    ...
    private static Effect getQuadHelixEffect(){
    	return new QuadHelixEffect(em());
    }
    private static Effect getJewEffect(){
    	ColoredImageEffect eff = new ColoredImageEffect(em());
        eff.registerPriority(new java.awt.Color(0, 0, 0));
       eff.loadFile("image_2.png");
       return eff;
    }
    private static Effect getZelluminatiEffect() {
        ColoredImageEffect eff = new ColoredImageEffect(em());
         eff.registerPriority(new java.awt.Color(0, 0, 0));
        eff.loadFile("smile4.png");
        return eff;
    }
