...
public class ShardManager extends AbstractManager {
    ...
    public void initialize() {
        ...
        lore.add(ChatColor.GRAY + "The official currency of "+Pluginc.server_name+"!");
        lore.add("");
