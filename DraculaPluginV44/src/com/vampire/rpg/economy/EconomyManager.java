package com.vampire.rpg.economy;
...
public class EconomyManager extends AbstractManager {
    ...
    public EconomyManager(Pluginc plugin) {
        super(plugin);
    }
    ...
    public static void openShardMenu(final Player p, final PlayerData pd) {
        p.closeInventory();
    ...
    public static void openSalvageMenu(final Player p, final PlayerData pd) {
        p.closeInventory();
        ...
        MenuManager.addMenuGeneralClick(p, new MenuGeneralRunnable<PlayerData>() {
            ...
            @Override
            public void execute(final Player p, PlayerData pd, ItemStack item, int slot) {
