...
public enum Badge {
    ...
    QUESTWRITER("Questwriter", "This player has written 10 or more quests that have been added to Fallen Gate.", "\u270E", ChatColor.AQUA), // 
    ...
    WIKI_TEAM("Wiki Team", "This player has made significant contributions to the Fallen Gate wiki.", "\u270D", ChatColor.GREEN), // 
    YT_1("Tier 1 Youtuber", "This player has made Youtube videos of Fallen Gate receiving over 5000 views in total.", "\u278A", ChatColor.RED), // 
    YT_2("Tier 2 Youtuber", "This player has made Youtube videos of Fallen Gate receiving over 20000 views in total.", "\u278B", ChatColor.RED), // 
    YT_3("Tier 3 Youtuber", "This player has made Youtube videos of Fallen Gate receiving over 50000 views in total.", "\u278C", ChatColor.RED), // 
    YT_4("Tier 4 Youtuber", "This player has made Youtube videos of Fallen Gate receiving over 150000 views in total.", "\u278D", ChatColor.RED), // 
    YT_5("Tier 5 Youtuber", "This player has made Youtube videos of Fallen Gate receiving over 1000000 views in total.", "\u278E", ChatColor.RED), // 
