package com.vampire.rpg.classes;
...
public class ClassManager extends AbstractManager {
    ...
    public ClassManager(Pluginc plugin) {
        super(plugin);
    }
    ...
    public static void changeClass(Player p, PlayerData pd, String className, ClassType classType, String weaponName) {
    ...
    public static void showAllClassMenu(final Player p, final PlayerData pd) {
     /*   if (p.getWorld().getName().equalsIgnoreCase(SakiRPG.TUTORIAL_WORLD)) {
        ...
        Inventory i = MenuManager.createMenu(p, "Drakona Classes", 1, new Object[][] {
                ...
                { 0, 2, Material.IRON_AXE, ChatColor.AQUA + "Barbarian", new Object[] {
                        ChatColor.GRAY,
                        "Battle Axe Users",
                        ChatColor.GREEN,
                    ...
                    public void run() {
                        ClassManager.changeClass(p, pd, "Barbarian", ClassType.BARBARIAN, "beginner_sword");
                    }
                }
                },
                { 0, 3, Material.IRON_SWORD, ChatColor.AQUA + "Crusader", new Object[] {
                        ChatColor.GRAY,
                        "Sword Users",
                        ChatColor.GREEN,
                        "A well-balanced class with good offense and defense.",
                ...
                { 0, 5, Material.SHEARS, ChatColor.AQUA + "Assassin", new Object[] {
                        ChatColor.GRAY,
                        "Dagger Users",
                        ChatColor.GREEN,
              ...
              /*  { 0, 5, Material.DIAMOND_HOE, ChatColor.AQUA + "Priest", new Object[] {
                        ChatColor.GRAY,
                        "Staff Users",
                        ChatColor.GREEN,
                        "A class that heals is great at killing big bosses with groups.",
                        null,
                        "",
                        //252
                        ChatColor.YELLOW,
    ...
    public static void showClassSpellMenu(final Player p, final PlayerData pd) {
    ...
    private static void showSpellcastChoices(final Spellcast spellcast, final Player p, final PlayerData pd, final boolean villager) {
    ...
    public static Inventory addClassSpells(Inventory inventory, Player p, PlayerData pd, boolean villager) {
        ArrayList<Object[]> obj = new ArrayList<Object[]>();
        if (villager) {
            for (Spell s : VillagerSpellbook.INSTANCE.getSpellList())
    ...
    private static Object[] generateShort(final Spellcast spellcast, int row, int col, final Spell s, final Player p, final PlayerData pd, final boolean villager) {
    ...
    public static Object[] generate(final Spell s, final Player p, final PlayerData pd, final boolean villager) {
        boolean passive = s.isPassive();
        final int currentLevel = pd.getSpellLevel(s);
        Object[] o = new Object[6];
        o[0] = s.row;
        ...
        Runnable r = new Runnable() {
            public void run() {
                if (System.currentTimeMillis() - pd.lastMenuClick < PlayerData.MENU_CLICK_RATE_LIMIT)
                    return;
